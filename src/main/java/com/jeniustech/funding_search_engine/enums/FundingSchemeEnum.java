...
public enum FundingSchemeEnum {
    ...
    JTI_CP_FCH("CP-CSA"),
    BSG_CSO("CP-IP"),
    JTI_CP_ENIAC("JTI-CP-FCH"),
    JTI_CSA_FCH("BSG-CSO"),
    JTI_CP_IMI("JTI-CP-ENIAC"),
    CP_CSA_Infra_PP("JTI-CSA-FCH"),
    CP_IP_SICA("JTI-CP-IMI"),
    CSA_ERA_Plus("CP-CSA-Infra-PP"),
    CP_SoU("CP-IP-SICA"),
    CSA_ERANET("CSA-ERA-Plus"),
    NoE("CP-SoU"),
    JTI_CP_ARTEMIS("CSA-ERANET");
