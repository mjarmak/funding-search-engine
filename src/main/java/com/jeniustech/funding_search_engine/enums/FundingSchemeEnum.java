...
public enum FundingSchemeEnum {
    ...
    CP("CP"),
    CSA_CA("CSA-CA"),
    CSA_SA_POC("CSA-SA(POC)"),
    MC_IRG("MC-IRG"),
    MC_CIG("MC-CIG"),
    MC_IIFR("MC-IIFR"),
    CP_CSA_Infra("CP-CSA-Infra"),
    MC_IOF("MC-IOF"),
    ERC_AG("ERC-AG"),
    MC_IRSES("MC-IRSES"),
    CPCSA("CPCSA"),
    BSG_SME("BSG-SME"),
    MC_ERG("MC-ERG"),
    CP_FP_SICA("CP-FP-SICA"),
    JTI_CS("JTI-CS"),
    CP_FP("CP-FP"),
    ERC_CG("ERC-CG"),
    MC_IAPP("MC-IAPP"),
    BSG_SME_AG("BSG-SME-AG"),
    CP_TP("CP-TP"),
    MC_ITN("MC-ITN"),
    CP_SICA("CP-SICA"),
    CP_CSA("CP-CSA"),
    CP_IP("CP-IP"),
    JTI_CP_FCH("JTI-CP-FCH"),
    BSG_CSO("BSG-CSO"),
    JTI_CP_ENIAC("JTI-CP-ENIAC"),
    JTI_CSA_FCH("JTI-CSA-FCH"),
    JTI_CP_IMI("JTI-CP-IMI"),
    CP_CSA_Infra_PP("CP-CSA-Infra-PP"),
    CP_IP_SICA("CP-IP-SICA"),
    CSA_ERA_Plus("CSA-ERA-Plus"),
    CP_SoU("CP-SoU"),
